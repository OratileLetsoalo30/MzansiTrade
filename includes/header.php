...
<nav class="navbar navbar-expand-lg navbar-dark shadow-sm py-3 msanzi-custom-nav" style="background-color: #0b3c4d;">
    <div class="container-fluid position-relative msanzi-nav-container" style="width: 100%;">
        ...
        <a class="navbar-brand d-flex align-items-center position-absolute msanzi-logo-left" href="index.php" style="left: 15px; top: 50%; transform: translateY(-50%); margin: 0; padding: 0; z-index: 10;">
            <img src="assets/img/logo.jpeg" alt="Mzansi Trade Logo" class="logo-blend" style="height: 50px; width: auto; mix-blend-mode: multiply;">
        </a>
            ...
            <div class="navbar-nav ms-auto align-items-center" style="margin-left: auto !important;">
                ...
                <div class="nav-item dropdown ms-3 text-end d-flex flex-column align-items-end">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2 p-0 rounded-0" aria-labelledby="userDropdown" style="width: 240px; border-top: 3px solid #f28e2b !important;">
                        ...
                        <li><a class="dropdown-item py-2.5 d-flex align-items-center gap-3" href="sell.php" style="color: #0b3c4d; font-size: 14px;">
                             <i class="bi bi-plus-circle fs-5" style="color: #f28e2b;"></i>Sell Item
                        </a></li>

                        <li><a class="dropdown-item py-2.5 d-flex align-items-center gap-3" href="auth/register.php" style="color: #0b3c4d; font-size: 14px;">
                            <i class="bi bi-person-plus fs-5" style="color: #0b3c4d;"></i>Register Account
                        </a></li>

                        <li><a class="dropdown-item py-2.5 d-flex align-items-center gap-3" href="auth/logout.php" style="color: #d93f3f; font-size: 14px; background-color: #fff5f5;">
