    ...
    <div class="row">
        <div class="col-md-4">
            <div class="mzansi-profile-card text-center">
                ...
                <div class="mb-3">
                    <span class="badge rounded-pill bg-light text-dark px-3 border"><?php echo ucfirst($user['role']); ?></span>
                </div>
                        ...
                        <?php if(mysqli_num_rows($my_items) > 0): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <a href="edit_item.php?id=<?php echo $item['id']; ?>" class="btn btn-sm btn-outline-secondary me-2">Edit</a>
                                    <a href="delete_item.php?id=<?php echo $item['id']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure?')">Delete</a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
